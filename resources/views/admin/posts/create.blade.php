...
@section('content')
          ...
          <ul class="breadcrumb">
            <div class="container-fluid">
              ...
              <li class="breadcrumb-item"><a href="{{ route('admin.posts') }}">Новости</a></li>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group-material">
                              <input id="posts-title" type="text" name="title" required class="input-material">
                              <label for="posts-title" class="label-material">Заголовок</label>
                            </div>
                            <div class="form-group-material">
                            ...
                            <div class="form-group-material" style="padding-left: 30px;">
                              <textarea id="posts-body" name="body" required class="form-control" placeholder="Текст"></textarea>
                            </div>
                          </div>
                        </div>
